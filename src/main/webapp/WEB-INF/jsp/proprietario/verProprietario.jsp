...
<form action="<c:url value='/proprietario/${proprietario.id }'/>" class="ls-form ls-form-horizontal row " data-ls-module="form" method="post">
	...
	<a href="<c:url value="/listarProprietarios"/>" class="ls-btn" data-ls-module="popover" data-trigger="hover" data-content="<p><fmt:message key="label.padrao.voltar"/></p>" data-placement="top">
		<i class="fa fa-reply"></i> 
	</a>
	
	<a href="<c:url value="/proprietario/editarProprietario/${proprietario.id}"/>" class="ls-btn" data-ls-module="popover" data-trigger="hover" data-content="<p><fmt:message key="label.padrao.alterar"/></p>" data-placement="top">
